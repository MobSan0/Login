...
<div class="container">
    <div class="jumbotron">
        ...
        <p>
            ...
            <a href="../Servico/services.php" class="btn btn-info btn-lg"> <i class="glyphicon glyphicon-briefcase"></i> Cadastrar/Ver Serviços
            </a>
            <a href="users.php" class="btn btn-warning btn-lg"> <i class="glyphicon glyphicon-list-alt"></i> Visualizar Usuários
            </a>
        </p>
    </div>
</div>
